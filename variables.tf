...
## Settings for sysdig helm chart
variable "sysdig_accessKey" {
  description = "The accessKey from sysdig"
  type        = string
}

variable "sysdig_collector" {
  description = "The collector host for sysdig"
  type        = string
  default     = "app.us4.sysdig.com"
}

variable "sysdig_collector_port" {
  description = "The collector port for sysdig"
  type        = string
  default     = "6443"
}

## Settings for gremlin
variable "gremlin_teamID" {
  description = "Gremlin TeamID"
  type        = string
}

variable "gremlin_clusterID" {
  description = "Gremlin Cluster ID"
  type        = string
  default     = ""
}

variable "gremlin_teamSecret" {
  description = "Gremlin Team Secret key"
  type        = string
  default     = ""
}
